...
let dirtTexture = new Texture("/WebGL-GameEngine/assets/texture/dirt.jpg")
    dirtTexture.setColorRGBA(159, 136, 105, 255)
let rjunTexture = new Texture("/WebGL-GameEngine/assets/texture/rjun.jpg")
    rjunTexture.setColorRGBA(255, 255, 255, 255)
let grassTexture = new Texture("/WebGL-GameEngine/assets/texture/grass.png")
    grassTexture.setColorRGBA(255, 255, 255, 255)
let transparentTexture = new Texture("/WebGL-GameEngine/assets/texture/road.png")
    transparentTexture.setColorRGBA(255, 255, 255, 255)
let transparentTextureDoor = new Texture("/WebGL-GameEngine/assets/texture/door.png")
    transparentTextureDoor.setColorRGBA(255, 255, 255, 255)
let colaTexture = new Texture("/WebGL-GameEngine/assets/texture/cola.png")
    colaTexture.setColorRGBA(255, 255, 255, 255)
let fridgeTexture = new Texture("/WebGL-GameEngine/assets/texture/fridge.png")
    fridgeTexture.setColorRGBA(255, 255, 255, 255)
let woodTexture = new Texture("/WebGL-GameEngine/assets/texture/wood.jpg")
    woodTexture.setColorRGBA(255, 255, 255, 255)
let houseTexture = new Texture("/WebGL-GameEngine/assets/texture/house.png")
...
let object = new Object(engine)
    ...
    object.loadFromObj("/WebGL-GameEngine/assets/objects/cola.obj")
...
let fridge = new Object(engine)
    ...
    fridge.loadFromObj("/WebGL-GameEngine/assets/objects/fridge.obj")
    fridge.scale(10, 10, 10)

let deer = new Object(engine)
    deer.setPosition(1000, 0, 800)
    deer.loadFromObj("/WebGL-GameEngine/assets/objects/deer.obj")
...
let house = new Object(engine)
    ...
    house.loadFromObj("/WebGL-GameEngine/assets/objects/house.obj")
