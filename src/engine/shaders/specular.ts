...
void main() {
  gl_FragColor = vec4(u_specular, 1.0);
}
`
  ...
  render(matrix: number[], vertices: WebGLBuffer, specular: number[], verticesCount: number) {
    ...
    this.webgl.uniform3fv(this.uniforms.u_specular, specular)
